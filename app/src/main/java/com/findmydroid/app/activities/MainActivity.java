...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_home: showHomeFragment(); break;
            case R.id.nav_settings: showSettingsFragment(); break;
            case R.id.nav_control: showControlLostPhoneFragment(); break;
            case R.id.nav_share: showShareDialog(); break;
            case R.id.nav_about: showAboutFragment(); break;
        }
    ...
    private void showHomeFragment() {
        ...
        transaction.replace(R.id.fragments_activity_main, homeFragment, "HomeFragment").commit();
    }
